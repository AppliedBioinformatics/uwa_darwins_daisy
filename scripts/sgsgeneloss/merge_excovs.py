...
if __name__ == "__main__":
    #merge_excovs_for_sample_set(master_folder=r"../../SGSGeneLoss_out", outdir_folder="../merged_excovs_test/")
    pav_df = create_pav_matrix(infolder="../../sgsgeneloss_results/")
    pav_df.to_csv("../../data/sgsgeneloss/pav_matrix.csv", index=True)

    # Create coverage matrix.
    cov_df = create_coverage_matrix(infolder="../../sgsgeneloss_results/")
    cov_df.to_csv("../../data/sgsgeneloss/cov_matrix.csv", index=True)
